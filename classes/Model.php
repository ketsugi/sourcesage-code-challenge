...
class Model {
	...
	public function __construct() {
		$this->db = new PDO(
			'mysql:unix_socket=/Applications/XAMPP/xamppfiles/var/mysql/mysql.sock;dbname=ketsugic_apps',
			/*'mysql:host=localhost;port=3306;dbname=ketsugic_apps',*/
			'ketsugic_apps',
			'F92EAB54D7D700'
			);
		...
		// Prepare statements
		$this->get_questions_stmt = $this->db->prepare("SELECT * FROM $this->questions_table");
